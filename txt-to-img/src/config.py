...
SEED_START_VALUE = 0  # For reproducibility if needed for seeds
NUM_INFERENCE_STEPS = 30

# --- Directory Setup ---
OUTPUT_DIR = Path("output")  # Changed name to avoid conflict
...
PROMPT_TEMPLATES = [
    ...
    # "a <CONTENT> in the style of <STYLE>",
    # "<CONTENT> <STYLE>",
    # "<CONTENT> . <STYLE>",
]
...
DEFAULT_IOU_THRESHOLD_FOR_VIS = [0.5, 0.4]
DEFAULT_USE_QUANTILE_FOR_VIS = [True, False]
