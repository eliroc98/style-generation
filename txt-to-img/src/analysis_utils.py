...
from daam import trace, set_seed  # Assuming daam is installed and accessible
from diffusers import DiffusionPipeline  # For type hinting
...
def calculate_iou_metrics(
    ...
    Returns:
        tuple: (iou_score, support_a_norm, support_b_norm, support_intersection_norm, support_union_norm)
    """
...
def save_image_with_heatmaps(
    pipe: DiffusionPipeline,  # Use the generic DiffusionPipeline for broader compatibility
    prompt: str,
    content_word: str,
    style_word: str,
    seed: int,
